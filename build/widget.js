...
/* WEBPACK VAR INJECTION */(function(jQuery) {var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;// daterangepicker.js
// version : 0.1.3
// author : Chunlong Liu
...
(function (factory) {
	...
	$.fn.dateRangePicker = function (opt) {
		...
		function init_datepicker() {
			...
			var defaultTopText = '';
			if (opt.singleDate) defaultTopText = lang('default-single');else if (opt.minDays && opt.maxDays) defaultTopText = lang('default-range');else if (opt.minDays) defaultTopText = lang('default-more');else if (opt.maxDays) defaultTopText = lang('default-less');else defaultTopText = lang('default-default');
			...
			box.find('[shortcut]').click(function () {
				...
				if (shortcut.indexOf('day') != -1) {
					...
					if (dir == 1) var stopDay = opt.startOfWeek == 'monday' ? 1 : 0;else var stopDay = opt.startOfWeek == 'monday' ? 0 : 6;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__widget_css__ = __webpack_require__(139);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__widget_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__widget_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__widget_jade__ = __webpack_require__(136);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__widget_jade___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__widget_jade__);
...
class Widget {
  constructor(options) {
    let form = new __WEBPACK_IMPORTED_MODULE_2__form_form__["a" /* default */](options.form);
    this.elem = document.createElement('div');
    this.elem.className = 'widget';

    this.elem.innerHTML = __WEBPACK_IMPORTED_MODULE_1__widget_jade___default()(options);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../css-loader/index.js!../../postcss-loader/index.js!./daterangepicker.css", function() {
			var newContent = require("!!../../css-loader/index.js!../../postcss-loader/index.js!./daterangepicker.css");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__node_modules_jquery_daterangepicker_lib_jquery_daterangepicker_js__ = __webpack_require__(120);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__node_modules_jquery_daterangepicker_lib_jquery_daterangepicker_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__node_modules_jquery_daterangepicker_lib_jquery_daterangepicker_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_jquery_daterangepicker_lib_daterangepicker_css__ = __webpack_require__(122);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_jquery_daterangepicker_lib_daterangepicker_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__node_modules_jquery_daterangepicker_lib_daterangepicker_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__widget_widget__ = __webpack_require__(121);
...
let widget = new __WEBPACK_IMPORTED_MODULE_2__widget_widget__["a" /* default */]({
...
$(document).ready(function () {
  ...
  let dateRangePickerOptions = {
    ...
    separator: '',
    getValue: function () {
      if ($('[data-range="from"]').val() && $('[data-range="to"]').val()) return $('[data-range="from"]').val() + ' to ' + $('[data-range="to"]').val();else return '';
    },
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__form_css__ = __webpack_require__(138);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__form_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__form_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__form_jade__ = __webpack_require__(135);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__form_jade___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__form_jade__);
...
class Form {
  constructor(options) {
    ...
    this.elem.innerHTML = __WEBPACK_IMPORTED_MODULE_1__form_jade___default()(options);
...
// module
exports.push([module.i, ".form {\n  max-width: 1024px;\n  font-size: 0\n}\n\n.form-field {\n  position: relative;\n}\n\n.form-field > input {\n  width: 100%;\n  display: block;\n  padding: 10.5px 10px;\n  background-color: #FFFFFF;\n  border-radius: 2px;\n  font-family: OpenSans;\n  font-size: 14px;\n  color: #9B9B9B;\n  box-shadow: none;\n  border: none;\n  outline: none\n}\n\n.form-field > input$(\"::-webkit-input-\")placeholder {\n  color: #9B9B9B;\n  font-size: 14px\n}\n\n.form-field > input$(\"::-moz-\")placeholder {\n  color: #9B9B9B;\n  font-size: 14px\n}\n\n.form-field > input$(\":-ms-input-\")placeholder {\n  color: #9B9B9B;\n  font-size: 14px\n}\n\n.form-field > input$(\":-moz-\")placeholder {\n  color: #9B9B9B;\n  font-size: 14px\n}\n\n.form-field > [type=\"submit\"] {\n  display: block;\n  width: 100%;\n  padding: 8px;\n  background-color: #F6A623;\n  box-shadow: inset 0 -2px 0 0 rgba(0,0,0,0.10);\n  border-radius: 2px;\n  font-family: OpenSans;\n  font-size: 20px;\n  color: #ffffff;\n  letter-spacing: 1.11px;\n  text-transform: uppercase;\n  line-height: 1\n}\n\n.form-field > [type=\"submit\"]:hover {\n  cursor: pointer\n}\n\n.form-field._icon {\n  }\n\n.form-field._icon:after {\n  content: '';\n  position: absolute;\n  top: 50%;\n  right: 10px;\n  -webkit-transform: translateY(-50%);\n          transform: translateY(-50%);\n  display: block;\n  width: 15px;\n  height: 20px;\n  background-image: url(\"data:image/svg+xml;charset=utf-8,%3C?xml version='1.0' encoding='UTF-8'?%3E %3Csvg width='15px' height='17px' viewBox='0 0 15 17' version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'%3E %3C!-- Generator: Sketch 43.1 (39012) - http://www.bohemiancoding.com/sketch --%3E %3Ctitle%3ECalendar%3C/title%3E %3Cdesc%3ECreated with Sketch.%3C/desc%3E %3Cdefs/%3E %3Cg id='Page-1' stroke='none' stroke-width='1' fill='none' fill-rule='evenodd'%3E %3Cg id='TP-test-form' transform='translate(-549.000000, -107.000000)' fill='#4990E2'%3E %3Cg id='Widest-form' transform='translate(50.000000, 50.000000)'%3E %3Cg id='Input1' transform='translate(324.000000, 45.000000)'%3E %3Cpath d='M177,19.9977418 C177,19.9977418 177.001596,27.2488688 177,27 L188.002502,26.9989014 C188.000907,26.9989014 187.997314,19.9994507 187.997314,19.9994507 L177,19.9977418 L177,19.9977418 L177,19.9977418 Z M183,23 L187,23 L187,26 L183,26 L183,23 L183,23 L183,23 Z M190,18 L190,27 C190,28.105 189.105,29 188,29 L177,29 C175.895,29 175,28.105 175,27 L175,18 L190,18 L190,18 L190,18 Z M187,13.9994999 L187,13.0002501 C187,12.448112 186.552,12 186,12 L185,12 C184.448,12 184,12.448112 184,13.0002501 L184,13.9994999 L181,13.9994999 L181,13.0002501 C181,12.448112 180.552,12 180,12 L179,12 C178.448,12 178,12.448112 178,13.0002501 L178,13.9994999 L177,13.9994999 C175.895,13.9994999 175,14.8947237 175,16 L190,16 C190,14.8947237 189.105,13.9994999 188,13.9994999 L187,13.9994999 L187,13.9994999 L187,13.9994999 Z' id='Calendar'/%3E %3C/g%3E %3C/g%3E %3C/g%3E %3C/g%3E %3C/svg%3E\");\n  background-repeat: no-repeat\n}\n\n@media (max-width: 767px) {\n  .form-field {\n  }\n  .form-field:not(:last-of-type) {\n    margin-bottom: 15px\n  }\n}\n\n@media (min-width: 440px) {\n  .form-field {\n    width: 50%;\n    display: inline-block;\n    margin-bottom: 20px;\n    vertical-align: middle\n  }\n  .form-field:nth-child(2) {\n    padding-left: 10px\n  }\n  .form-field:first-child {\n    padding-right: 10px\n  }\n  .form-field:first-child._icon {\n  }\n  .form-field:first-child._icon:after {\n    right: calc(10px * 2)\n  }\n  .form-field:last-child {\n    display: block;\n    width: 100%;\n    margin-bottom: 0\n  }\n}\n\n@media (min-width: 768px) {\n  .form-field {\n    width: 33.333333%;\n    margin-bottom: 0\n  }\n  .form-field:nth-child(2) {\n    padding-right: 10px\n  }\n  .form-field:nth-child(2)._icon {\n  }\n  .form-field:nth-child(2)._icon:after {\n    right: calc(10px * 2)\n  }\n  .form-field:last-child {\n    display: inline-block;\n    width: 33.333333%;\n    padding-left: 10px\n  }\n}\n\n@media (min-width: 1024px) {\n  .form {\n    display: inline-block;\n    width: 75%;\n    padding-left: 10px;\n    vertical-align: middle;\n  }\n}", ""]);
...
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (inputs, submit, undefined) {
// iterate inputs
;(function(){
  var $$obj = inputs;
...
buf.push("<div class=\"form-field _icon\"><input" + (jade.attr("type", "" + (input.type) + "", true, true)) + (jade.attr("placeholder", "" + (input.placeholder) + "", true, true)) + (jade.attr("data-range", "" + (input.attr) + "", true, true)) + " required></div>");
    }
...
buf.push("<div class=\"form-field\"><button" + (jade.attr("type", "" + (submit.type) + "", true, true)) + (jade.attr("value", "" + (submit.title) + "", true, true)) + ">" + (jade.escape((jade_interp = submit.title) == null ? '' : jade_interp)) + "</button></div>");}.call(this,"inputs" in locals_for_with?locals_for_with.inputs:typeof inputs!=="undefined"?inputs:undefined,"submit" in locals_for_with?locals_for_with.submit:typeof submit!=="undefined"?submit:undefined,"undefined" in locals_for_with?locals_for_with.undefined: false?undefined:undefined));;return buf.join("");
}
...
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (desc, title) {
buf.push("<div class=\"widget-title\">" + (jade.escape((jade_interp = title) == null ? '' : jade_interp)) + "</div><div class=\"widget-desc\">" + (jade.escape((jade_interp = desc) == null ? '' : jade_interp)) + "</div>");}.call(this,"desc" in locals_for_with?locals_for_with.desc:typeof desc!=="undefined"?desc:undefined,"title" in locals_for_with?locals_for_with.title:typeof title!=="undefined"?title:undefined));;return buf.join("");
}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/postcss-loader/index.js!./widget.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/postcss-loader/index.js!./widget.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
